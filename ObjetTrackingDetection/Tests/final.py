...
while True:
    ...
    if not tracker_initialized:
        ...
        if success:
            if not is_significant_motion_present(bbox, frame, background):
                print("No significant motion detected. Resetting tracker...")
                tracker_initialized = False
            else:
                ...
                center_x = bbox[0] + bbox[2] / 2  # Define center_x based on current bbox
                center_y = bbox[1] + bbox[3] / 2  # Define center_y based on current bbox
